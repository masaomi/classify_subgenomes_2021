...
ruby scripts/scaff_ab_homeolog_count_ratio.rb references/2Es_HS_3.2.1_genome.fa references/2Es_HS_3.2.1_genes.gff homeolog_list.dat --a_homeolog_ratio 0.5 2> /dev/null
